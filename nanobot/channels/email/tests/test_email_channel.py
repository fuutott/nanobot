...
async def test_send_port_587_with_ssl_enabled_falls_back_to_starttls(monkeypatch) -> None:
    ...
    monkeypatch.setattr("nanobot.channels.email.runtime.smtplib.SMTP", _smtp_factory)
    monkeypatch.setattr("nanobot.channels.email.runtime.smtplib.SMTP_SSL", FakeSMTPSSL)
...
async def test_send_port_465_uses_smtp_ssl_even_when_only_tls_enabled(monkeypatch) -> None:
    ...
    monkeypatch.setattr("nanobot.channels.email.runtime.smtplib.SMTP", FakeSMTP)
    monkeypatch.setattr("nanobot.channels.email.runtime.smtplib.SMTP_SSL", _smtp_ssl_factory)
