...
2. "memory_update": The updated long-term memory content. CRITICAL: You MUST preserve ALL existing content verbatim. Only append new facts or update individual lines — never omit or replace existing information. Add any new facts: user location, preferences, personal info, habits, project context, technical decisions, tools/services used. If nothing new, return the existing content unchanged exactly.
